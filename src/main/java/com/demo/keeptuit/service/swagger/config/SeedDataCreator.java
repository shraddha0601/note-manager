package com.demo.keeptuit.service.swagger.config;
...
public class SeedDataCreator {
    ...
    private void init() {
        ...
        UserDb user3 = new UserDb().withUserName("Yoda").withFirstName("YJedi").withLastName("Skywalker").withNotes(Arrays.asList(note3));
        note1.setUser(user1);

        UserDb user4 = new UserDb().withUserName("Obiwan").withFirstName("OJedi").withLastName("Skywalker").withNotes(Arrays.asList(note4));
        note1.setUser(user1);
